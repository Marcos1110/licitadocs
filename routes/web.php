...
Route::middleware('auth')->group(function () {
    ...
    Route::controller(DocumentosController::class)->group(function () {
        ...
        Route::post('/upload', 'store')->name('documentos.store');
        Route::get('/documentos/{id}', 'viewer')->name('documentos.viewer');
        Route::get('/documento/{id}/arquivo', 'show')->name('documento.visualizar');
    });
